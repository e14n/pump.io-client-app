// requesttoken.js
//
// data object representing a requesttoken
//
...
RequestToken.key = function(hostname, token) {
    return hostname + "/" + token;
};

RequestToken.beforeCreate = function(props, callback) {
    ...
    if (!_.has(props, "hostname_token")) {
        props.hostname_token = RequestToken.key(props.hostname, props.token);
    }
